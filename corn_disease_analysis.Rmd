...
summary_rust %>%
  ...
  theme_classic()
ggsave(path = "../diseases", filename = "Rust vs Corn Type.png")
...
summary_rust %>%
  ...
  theme_classic()
ggsave(path = "../diseases", filename = "Rust vs Fertilizer Treatment.png")

# by province
aov_province_rust <- aov(percent_incidence_rust ~ Province, data = summary_rust)
tukeyhsd_province_rust <- TukeyHSD(aov_province_rust)
letters_province_rust <- multcompLetters4(aov_province_rust, tukeyhsd_province_rust)

# median values on boxplots
summary_rust_province_bp <-
  summary_rust %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_rust), sd = mean_sd(percent_incidence_rust)) %>% 
  arrange(desc(w)) 

summary_rust_province_bp$province_cld <- 
  as.data.frame.list(letters_province_rust$Province)$Letters

dunnTest(percent_incidence_rust ~ Province, data = summary_rust)

attach(summary_rust)
province_rust_df <- as.list.data.frame(dunn.test(percent_incidence_rust, Province, list = TRUE))
detach(summary_rust)
...
summary_rust %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_rust_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_rust_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Common Rust",
       title = "Provinces to Common Rust Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Corn Common Rust Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
# median values on boxplots
summary_rust_corn_stage_bp <- 
  summary_rust %>% 
  group_by(crop_stage) %>% 
  summarise(w=median(percent_incidence_rust), sd = mean_sd(percent_incidence_rust)) %>% 
  arrange(desc(w))

aov_stage_rust <- aov(percent_incidence_rust ~ crop_stage, data = summary_rust)
tukeyhsd_stage_rust <- TukeyHSD(aov_stage_rust)
letters_stage_rust <- multcompLetters4(aov_stage_rust, tukeyhsd_stage_rust)

aov_stage_rust %>% summary()

summary_rust_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_rust$crop_stage)$Letters

dunnTest(percent_incidence_rust ~ crop_stage, data = summary_rust)

attach(summary_rust)
stage_rust_df <- as.list.data.frame(dunn.test(percent_incidence_rust, crop_stage, list = TRUE))
detach(summary_rust)
...
summary_rust %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_rust_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_rust_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Common Rust",
       title = "Corn Crop Growth Stages and Common Rust Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Common Rust Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_southrust <- aov(percent_incidence_southrust ~ Province, data = summary_southrust)
tukeyhsd_province_southrust <- TukeyHSD(aov_province_southrust)
letters_province_southrust <- multcompLetters4(aov_province_southrust, tukeyhsd_province_southrust)

# median values on boxplots
summary_southrust_province_bp <-
  summary_southrust %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_southrust), sd = mean_sd(percent_incidence_southrust)) %>% 
  arrange(desc(w)) 

summary_southrust_province_bp$province_cld <- 
  as.data.frame.list(letters_province_southrust$Province)$Letters

dunnTest(percent_incidence_southrust ~ Province, data = summary_southrust)

attach(summary_southrust)
province_southrust_df <- as.list.data.frame(dunn.test(percent_incidence_southrust, Province, list = TRUE))
detach(summary_southrust)
...
summary_southrust %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_southrust_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_southrust_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Southern Rust",
       title = "Provinces to Southern Rust Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Southern Rust Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
# median values on boxplots
summary_southrust_corn_stage_bp <- 
  summary_southrust %>% 
  group_by(crop_stage) %>% 
  summarise(w=median(percent_incidence_southrust), sd = mean_sd(percent_incidence_southrust)) %>% 
  arrange(desc(w))

aov_stage_southrust <- aov(percent_incidence_southrust ~ crop_stage, data = summary_southrust)
tukeyhsd_stage_southrust <- TukeyHSD(aov_stage_southrust)
letters_stage_southrust <- multcompLetters4(aov_stage_southrust, tukeyhsd_stage_southrust)

aov_stage_southrust %>% summary()

summary_southrust_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_southrust$crop_stage)$Letters

dunnTest(percent_incidence_southrust ~ crop_stage, data = summary_southrust)

attach(summary_southrust)
stage_southrust_df <- as.list.data.frame(dunn.test(percent_incidence_southrust, crop_stage, list = TRUE))
detach(summary_southrust)
...
summary_southrust %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_southrust_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_southrust_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Southern Rust",
       title = "Corn Crop Growth Stages and Southern Rust Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Southern Rust Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_mildew <- aov(percent_incidence_mildew ~ Province, data = summary_mildew)
tukeyhsd_province_mildew <- TukeyHSD(aov_province_mildew)
letters_province_mildew <- multcompLetters4(aov_province_mildew, tukeyhsd_province_mildew)

# median values on boxplots
summary_mildew_province_bp <-
  summary_mildew %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_mildew), sd = mean_sd(percent_incidence_mildew)) %>% 
  arrange(desc(w)) 

summary_mildew_province_bp$province_cld <- 
  as.data.frame.list(letters_province_mildew$Province)$Letters

dunnTest(percent_incidence_mildew ~ Province, data = summary_mildew)

attach(summary_mildew)
province_mildew_df <- as.list.data.frame(dunn.test(percent_incidence_mildew, Province, list = TRUE))
detach(summary_mildew)
...
summary_mildew %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_mildew_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_mildew_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Downy Mildew",
       title = "Provinces to Downy Mildew Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Downy Mildew Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
# median values on boxplots
summary_mildew_corn_stage_bp <- 
  summary_mildew %>% 
  group_by(crop_stage) %>% 
  summarise(w=median(percent_incidence_mildew), sd = mean_sd(percent_incidence_mildew)) %>% 
  arrange(desc(w))

aov_stage_mildew <- aov(percent_incidence_mildew ~ crop_stage, data = summary_mildew)
tukeyhsd_stage_mildew <- TukeyHSD(aov_stage_mildew)
letters_stage_mildew <- multcompLetters4(aov_stage_mildew, tukeyhsd_stage_mildew)

aov_stage_mildew %>% summary()

summary_mildew_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_mildew$crop_stage)$Letters

dunnTest(percent_incidence_mildew ~ crop_stage, data = summary_mildew)

attach(summary_mildew)
stage_mildew_df <- as.list.data.frame(dunn.test(percent_incidence_mildew, crop_stage, list = TRUE))
detach(summary_mildew)
...
summary_mildew %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_mildew_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_mildew_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Downy Mildew",
       title = "Corn Crop Growth Stages and Downy Mildew Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Downy Mildew Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_brown <- aov(percent_incidence_brown ~ Province, data = summary_brown)
tukeyhsd_province_brown <- TukeyHSD(aov_province_brown)
letters_province_brown <- multcompLetters4(aov_province_brown, tukeyhsd_province_brown)

# median values on boxplots
summary_brown_province_bp <-
  summary_brown %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_brown), sd = mean_sd(percent_incidence_brown)) %>% 
  arrange(desc(w)) 

summary_brown_province_bp$province_cld <- 
  as.data.frame.list(letters_province_brown$Province)$Letters

dunnTest(percent_incidence_brown ~ Province, data = summary_brown)

attach(summary_brown)
province_brown_df <- as.list.data.frame(dunn.test(percent_incidence_brown, Province, list = TRUE))
detach(summary_brown)
...
summary_brown %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_brown_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_brown_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Brown Spot",
       title = "Provinces to Brown Spot Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Brown Spot Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
# median values on boxplots
summary_brown_corn_stage_bp <- 
  summary_brown %>% 
  group_by(crop_stage) %>% 
  summarise(w=median(percent_incidence_brown), sd = mean_sd(percent_incidence_brown)) %>% 
  arrange(desc(w))

aov_stage_brown <- aov(percent_incidence_brown ~ crop_stage, data = summary_brown)
tukeyhsd_stage_brown <- TukeyHSD(aov_stage_brown)
letters_stage_brown <- multcompLetters4(aov_stage_brown, tukeyhsd_stage_brown)

aov_stage_brown %>% summary()

summary_brown_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_brown$crop_stage)$Letters

dunnTest(percent_incidence_brown ~ crop_stage, data = summary_brown)

attach(summary_brown)
stage_brown_df <- as.list.data.frame(dunn.test(percent_incidence_brown, crop_stage, list = TRUE))
detach(summary_brown)
...
summary_brown %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_brown_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_brown_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Brown Spot",
       title = "Corn Crop Growth Stages and Brown Spot Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Brown Spot Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_leaf <- aov(percent_incidence_leaf ~ Province, data = summary_leaf)
tukeyhsd_province_leaf <- TukeyHSD(aov_province_leaf)
letters_province_leaf <- multcompLetters4(aov_province_leaf, tukeyhsd_province_leaf)

# median values on boxplots
summary_leaf_province_bp <-
  summary_leaf %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_leaf), sd = mean_sd(percent_incidence_leaf)) %>% 
  arrange(desc(w)) 

summary_leaf_province_bp$province_cld <- 
  as.data.frame.list(letters_province_leaf$Province)$Letters

dunnTest(percent_incidence_leaf ~ Province, data = summary_leaf)

attach(summary_leaf)
province_leaf_df <- as.list.data.frame(dunn.test(percent_incidence_leaf, Province, list = TRUE))
detach(summary_leaf)
...
summary_leaf %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_leaf_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_leaf_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Leaf Spot",
       title = "Provinces to Leaf Spot Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Leaf Spot Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
# median values on boxplots
summary_leaf_corn_stage_bp <- 
  summary_leaf %>% 
  group_by(crop_stage) %>% 
  summarise(w=median(percent_incidence_leaf), sd = mean_sd(percent_incidence_leaf)) %>% 
  arrange(desc(w))

aov_stage_leaf <- aov(percent_incidence_leaf ~ crop_stage, data = summary_leaf)
tukeyhsd_stage_leaf <- TukeyHSD(aov_stage_leaf)
letters_stage_leaf <- multcompLetters4(aov_stage_leaf, tukeyhsd_stage_leaf)

aov_stage_leaf %>% summary()

summary_leaf_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_leaf$crop_stage)$Letters

dunnTest(percent_incidence_leaf ~ crop_stage, data = summary_leaf)

attach(summary_leaf)
stage_leaf_df <- as.list.data.frame(dunn.test(percent_incidence_leaf, crop_stage, list = TRUE))
detach(summary_leaf)
...
summary_leaf %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_leaf_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_leaf_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Leaf Spot",
       title = "Corn Crop Growth Stages and Leaf Spot Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Leaf Spot Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_blight <- aov(percent_incidence_blight ~ Province, data = summary_blight)
tukeyhsd_province_blight <- TukeyHSD(aov_province_blight)
letters_province_blight <- multcompLetters4(aov_province_blight, tukeyhsd_province_blight)

# median values on boxplots
summary_blight_province_bp <-
  summary_blight %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_blight), sd = mean_sd(percent_incidence_blight)) %>% 
  arrange(desc(w)) 

summary_blight_province_bp$province_cld <- 
  as.data.frame.list(letters_province_blight$Province)$Letters

dunnTest(percent_incidence_blight ~ Province, data = summary_blight)

attach(summary_blight)
province_blight_df <- as.list.data.frame(dunn.test(percent_incidence_blight, Province, list = TRUE))
detach(summary_blight)
...
summary_blight %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_blight_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_blight_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Leaf Blight",
       title = "Provinces to Leaf Blight Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Leaf Blight Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
# median values on boxplots
summary_blight_corn_stage_bp <- 
  summary_blight %>% 
  group_by(crop_stage) %>% 
  summarise(w=median(percent_incidence_blight), sd = mean_sd(percent_incidence_blight)) %>% 
  arrange(desc(w))

aov_stage_blight <- aov(percent_incidence_blight ~ crop_stage, data = summary_blight)
tukeyhsd_stage_blight <- TukeyHSD(aov_stage_blight)
letters_stage_blight <- multcompLetters4(aov_stage_blight, tukeyhsd_stage_blight)

aov_stage_blight %>% summary()

summary_blight_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_blight$crop_stage)$Letters

dunnTest(percent_incidence_blight ~ crop_stage, data = summary_blight)

attach(summary_blight)
stage_blight_df <- as.list.data.frame(dunn.test(percent_incidence_blight, crop_stage, list = TRUE))
detach(summary_blight)
...
summary_blight %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_blight_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_blight_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Leaf Blight",
       title = "Corn Crop Growth Stages and Leaf Blight Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Leaf Blight Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_stalk <- aov(percent_incidence_stalk ~ Province, data = summary_stalk)
tukeyhsd_province_stalk <- TukeyHSD(aov_province_stalk)
letters_province_stalk <- multcompLetters4(aov_province_stalk, tukeyhsd_province_stalk)

# median values on boxplots
summary_stalk_province_bp <-
  summary_stalk %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_stalk), sd = mean_sd(percent_incidence_stalk)) %>% 
  arrange(desc(w)) 

summary_stalk_province_bp$province_cld <- 
  as.data.frame.list(letters_province_stalk$Province)$Letters

dunnTest(percent_incidence_stalk ~ Province, data = summary_stalk)

attach(summary_stalk)
province_stalk_df <- as.list.data.frame(dunn.test(percent_incidence_stalk, Province, list = TRUE))
detach(summary_stalk)
...
summary_stalk %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_stalk_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_stalk_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Stalk Rot",
       title = "Provinces to Stalk Rot Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Corn Stalk Rot Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
# median values on boxplots
summary_stalk_corn_stage_bp <- 
  summary_stalk %>% 
  group_by(crop_stage) %>% 
  summarise(w=median(percent_incidence_stalk), sd = mean_sd(percent_incidence_stalk)) %>% 
  arrange(desc(w))

aov_stage_stalk <- aov(percent_incidence_stalk ~ crop_stage, data = summary_stalk)
tukeyhsd_stage_stalk <- TukeyHSD(aov_stage_stalk)
letters_stage_stalk <- multcompLetters4(aov_stage_stalk, tukeyhsd_stage_stalk)

aov_stage_stalk %>% summary()

summary_stalk_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_stalk$crop_stage)$Letters

dunnTest(percent_incidence_stalk ~ crop_stage, data = summary_stalk)

attach(summary_stalk)
stage_stalk_df <- as.list.data.frame(dunn.test(percent_incidence_stalk, crop_stage, list = TRUE))
detach(summary_stalk)
...
summary_stalk %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_stalk_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_stalk_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Stalk Rot",
       title = "Corn Crop Growth Stages and Stalk Rot Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Stalk Rot Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
levenes_disease_values <-
  data.frame(
    Pest = c("BLSB", "Common Rust", "Leaf Spot","Southern Rust", "Downy mildew", "Blight", "Stalk rot", "Brown Spot"),
