...
ggsave(path = "../province", filename = "BLSB Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_blsb %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "BLSB Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_rust %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Common Rust Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_rust %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Common Rust Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_southrust %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Southern Rust Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_southrust %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Southern Rust Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_mildew %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Downy Mildew Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_mildew %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Downy Mildew Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_brown %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Brown Spot Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_brown %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Brown Spot Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_leaf %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Leaf Spot Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_leaf %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Leaf Spot Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_blight %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Leaf Blight Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_blight %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Leaf Blight Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_stalk %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Stalk Rot Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_stalk %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Stalk Rot Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
p_val_stalk_corntype <- utest_corn_stalk$p.value[[1]]
stat_val_stalk_corntype <- utest_corn_stalk$statistic[[1]]
