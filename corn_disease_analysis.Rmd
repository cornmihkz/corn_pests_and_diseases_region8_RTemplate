...
blsb_joined_ev <-
  ...
  mutate(sum_no = sum(c_across(starts_with("BandedLeaf and Sheath Blight")) == "0"),
         ...
         average_damage_blsb = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants)),
         damage_rating_blsb = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants * 9)) * percent_100,
...
blsb_joined_ev %>%
  ...
  labs(x = "Monthly average temperature (C)", y = "Incidence blsb") +
...
blsb_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Wind Speed (km/h)", y = "Incidence BLSB") +
...
blsb_joined_ev %>%
  ...
  labs(x = "Monthly Average Humidity (%)", y = "Incidence BLSB") +
...
blsb_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Rainfall (mm)", y = "Incidence BLSB") +
...
rust_joined_ev <-
  ...
  mutate(sum_no = sum(c_across(starts_with("Common Rust")) == "0"),
         ...
         average_damage_rust = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants)),
         damage_rating_rust = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants * 9)) * percent_100,
...
rust_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence rust") +
  annotate("label", x = 27.5, y = 12,  
           label = temp_rust_eqn,
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
...
rust_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Wind Speed (km/h)", y = "Incidence rust") +
  annotate("label", x = 7, y = 11,  
           label = wind_rust_eqn,
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
...
rust_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly Average Humidity (%)", y = "Incidence rust") +
  annotate("label", x = 60, y = 11,  
...
rust_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Rainfall (mm)", y = "Incidence rust") +
  annotate("label", x = 0.4, y = 13,  
           label = rain_rust_eqn,
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
...
southrust_joined_ev <-
  ...
  mutate(sum_no = sum(c_across(starts_with("Southern Rust")) == "0"),
         ...
         average_damage_southrust = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants)),
         damage_rating_southrust = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants * 9)) * percent_100,
...
southrust_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence southrust") +
  annotate("label", x = 27.5, y = 12,  
...
southrust_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Wind Speed (km/h)", y = "Incidence southrust") +
  annotate("label", x = 7, y = 11,  
...
southrust_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly Average Humidity (%)", y = "Incidence southrust") +
  annotate("label", x = 60, y = 11,  
...
southrust_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Rainfall (mm)", y = "Incidence southrust") +
  annotate("label", x = 0.4, y = 13,  
...
mildew_joined_ev <-
  ...
  mutate(sum_no = sum(c_across(starts_with("Downy Mildew")) == "0"),
         ...
         average_damage_mildew = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants)),
         damage_rating_mildew = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants * 9)) * percent_100,
...
mildew_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence mildew") +
  annotate("label", x = 27.5, y = 12,  
...
mildew_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Wind Speed (km/h)", y = "Incidence mildew") +
  annotate("label", x = 7, y = 11,  
...
mildew_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly Average Humidity (%)", y = "Incidence mildew") +
  annotate("label", x = 60, y = 11,  
...
mildew_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Rainfall (mm)", y = "Incidence mildew") +
  annotate("label", x = 0.4, y = 13,  
...
brown_joined_ev <-
  ...
  mutate(sum_no = sum(c_across(starts_with("Brown Spot")) == "0"),
         ...
         average_damage_brown = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants)),
         damage_rating_brown = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants * 9)) * percent_100,
...
brown_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence brown") +
  annotate("label", x = 27.5, y = 12,  
...
brown_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Wind Speed (km/h)", y = "Incidence brown") +
...
brown_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly Average Humidity (%)", y = "Incidence brown") +
  annotate("label", x = 60, y = 11,  
...
brown_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Rainfall (mm)", y = "Incidence brown") +
  annotate("label", x = 0.4, y = 13,  
...
leaf_joined_ev <-
  ...
  mutate(sum_no = sum(c_across(starts_with("Leaf Spot")) == "0"),
         ...
         average_damage_leaf = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants)),
         damage_rating_leaf = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants * 9)) * percent_100,
...
leaf_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence leaf") +
...
leaf_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Wind Speed (km/h)", y = "Incidence leaf") +
...
leaf_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly Average Humidity (%)", y = "Incidence leaf") +
...
leaf_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Rainfall (mm)", y = "Incidence leaf") +
...
blight_joined_ev <-
  ...
  mutate(sum_no = sum(c_across(starts_with("Leaf Blight")) == "0"),
         ...
         average_damage_blight = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants)),
         damage_rating_blight = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants * 9)) * percent_100,
...
blight_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence blight") +
...
blight_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Wind Speed (km/h)", y = "Incidence blight") +
...
blight_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly Average Humidity (%)", y = "Incidence blight") +
...
blight_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Rainfall (mm)", y = "Incidence blight") +
  annotate("label", x = 0.4, y = 15,  
...
stalk_joined_ev <-
  ...
  mutate(sum_no = sum(c_across(starts_with("Stalk Rot")) == "0"),
         ...
         average_damage_stalk = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants)),
         damage_rating_stalk = (((1 * sum_slight) + (3 * sum_slight) + (5 * sum_moderate) + (7 * sum_heavy) + (9 * sum_very)) / (number_sampled_plants * 9)) * percent_100,
...
stalk_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly average temperature (C)", y = "Incidence stalk") +
  annotate("label", x = 27.5, y = 13,  
...
stalk_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Wind Speed (km/h)", y = "Incidence stalk") +
...
stalk_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.7) +
  labs(x = "Monthly Average Humidity (%)", y = "Incidence stalk") +
  annotate("label", x = 60, y = 13,  
...
stalk_joined_ev %>%
  ...
  geom_point(color = "gray", show.legend = FALSE) +
  geom_smooth(formula = "y~x", method="lm", se=FALSE, size = 1.5) +
  labs(x = "Monthly Average Rainfall (mm)", y = "Incidence stalk") +
  annotate("label", x = 0.4, y = 15,  
