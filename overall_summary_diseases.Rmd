...
write.csv(summary_diseases_region, "../report_/Regional Top Diseases Percent Incidence.csv")
#####
...
write.csv(summary_diseases_corntype_NGM, "../report_/Top Diseases NGM Corn Type Percent Incidence.csv")

summary_diseases_corntype_GM <-
  summary_diseases_corntype %>% 
  select(Diseases, GM.Percent.Incidence) %>%
  arrange(desc(GM.Percent.Incidence))
write.csv(summary_diseases_corntype_GM, "../report_/Top Diseases GM Corn Type Percent Incidence.csv")
#####
...
summary_diseases_Leyte <-
  ...
  arrange(desc(Leyte))
write.csv(summary_diseases_Leyte, "../report_/Top Diseases Leyte Percent Incidence.csv")
...
write.csv(summary_diseases_So_Leyte, "../report_/Top Diseases Southern Leyte Percent Incidence.csv")

summary_diseases_Samar <-
  summary_diseases_province %>% 
  select(Diseases, Samar) %>%
  arrange(desc(Samar))
write.csv(summary_diseases_Samar, "../report_/Top Diseases Samar Percent Incidence.csv")
#######
...
summary_diseases_rfr_fertilizer <-
  ...
  select(Diseases, RFR) %>%
  arrange(desc(RFR))
write.csv(summary_diseases_rfr_fertilizer, "../report_/Top Diseases by RFR Fertilizer Treatment Percent Incidence.csv")
...
summary_diseases_brfr_fertilizer <-
  ...
  arrange(desc(BRFR))
write.csv(summary_diseases_brfr_fertilizer, "../report_/Top Diseases by BRFR Fertilizer Treatment Percent Incidence.csv")
...
summary_diseases_arfr_fertilizer <-
  ...
  arrange(desc(ARFR))
write.csv(summary_diseases_arfr_fertilizer, "../report_/Top Diseases by ARFR Fertilizer Treatment Percent Incidence.csv")
#######
...
write.csv(summary_diseases_crop_stage, "../report_/Summary of Corn Crop Stage Disease Incidences .csv")

summary_diseases_single_leaf <-
  summary_diseases_crop_stage %>% 
  select(Diseases, Single_leaf) %>%
  arrange(desc(Single_leaf))
write.csv(summary_diseases_single_leaf, "../report_/Top Diseases during Single leaf `Crop Stage` Percent Incidence.csv")
...
write.csv(summary_diseases_mid_whorl, "../report_/Top Diseases during Mid whorl `Crop Stage` Percent Incidence.csv")
...
write.csv(summary_diseases_early_whorl, "../report_/Top Diseases during Early whorl `Crop Stage` Percent Incidence.csv")
...
write.csv(summary_diseases_late_whorl, "../report_/Top Diseases during Late whorl `Crop Stage` Percent Incidence.csv")
...
write.csv(summary_diseases_seedling, "../report_/Top Diseases during Seedling `Crop Stage` Percent Incidence.csv")
...
write.csv(summary_diseases_tasseling, "../report_/Top Diseases during Tasseling `Crop Stage` Percent Incidence.csv")
...
write.csv(summary_diseases_silking, "../report_/Top Diseases during Silking `Crop Stage` Percent Incidence.csv")
...
write.csv(summary_diseases_maturity, "../report_/Top Diseases during Maturity `Crop Stage` Percent Incidence.csv")
#####
...
write.csv(summary_diseases_monthly, "../report_/Monthly Disease Incidence Jan-June .csv")
#####
...
ggsave("../report_/Diseases Plots/Top 3 Diseases in Region 8.png", dpi = plot_dpi)
...
summary_diseases_corntype %>%
  ...
  theme(plot.title.position = "panel",
        plot.title = element_text(margin = margin(t = -5, b=20),
                                  ...
                                  vjust = -115),
        plot.margin = margin(t = 10, l = 10, b = 20))
ggsave("../report_/Diseases Plots/Top 3 Diseases by Corn Type in Region 8.png", dpi = plot_dpi)
#####
...
summary_diseases_fertilizer  %>%
  ...
  theme(plot.title.position = "panel",
        plot.title = element_text(margin = margin(t = -5, b=20),
                                  ...
                                  vjust = -115),
        plot.margin = margin(t = 10, l = 10, b = 20))
ggsave("../report_/Diseases Plots/Top 3 Diseases by Fertilizer Treatment Rate in Region 8.png", dpi = plot_dpi)
#####
...
summary_diseases_province %>%
  ...
  theme(plot.title.position = "panel",
        plot.title = element_text(margin = margin(t = -5, b=20),
                                  ...
                                  vjust = -115),
        plot.margin = margin(t = 10, l = 10, b = 20))
ggsave("../report_/Diseases Plots/Top 3 Diseases by Province in Region 8.png", dpi = plot_dpi)
...
write.csv(weather_disease_corr, "../report_/Weather_Diseases_Correlation.csv")
...
summary_pests_crop_stage_plot %>%
  ...
  theme(plot.title.position = "panel",
        plot.title = element_text(margin = margin(t=5, b=15),
                                  ...
                                  vjust = -133),
        plot.margin = margin(t = -10, l = 10, b = 20))
ggsave("../report_/Summary of Pest Incidences Per Growth Stage from January - June .png", dpi = plot_dpi, height = plot_height)
...
summary_pests_monthly_plot %>%
  ...
  theme(plot.title.position = "panel",
        plot.title = element_text(margin = margin(t=5, b=15),
                                  ...
                                  vjust = -133),
        plot.margin = margin(t = -10, l = 10, b = 20))
ggsave("../report_/Summary of Monthly Pest Incidences from January - June .png", dpi = plot_dpi, height = plot_height)
####
```
...
summary_diseases_crop_stage_plot %>%
  ...
  theme(plot.title.position = "panel",
        plot.title = element_text(margin = margin(t=5, b=15),
                                  ...
                                  vjust = -133),
        plot.margin = margin(t = -10, l = 10, b = 20))
ggsave("../report_/Summary of Disease Incidences Per Growth Stage from January - June .png", dpi = plot_dpi, height = plot_height)
...
summary_diseases_monthly_plot %>%
  ...
  theme(plot.title.position = "panel",
        plot.title = element_text(margin = margin(t=5, b=15),
                                  ...
                                  vjust = -133),
        plot.margin = margin(t = -10, l = 10, b = 20))
ggsave("../report_/Summary of Monthly Disase Incidences from January - June .png", dpi = plot_dpi, height = plot_height)
```
