...
borer_joined_ev %>%
  ...
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer vs Temperature.png")
...
borer_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer vs Wind.png")
...
borer_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer vs Humidity.png")
...
borer_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer vs Rain.png")
...
summary_borer %>%
  ...
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer Percent Incidence vs Corn Type.png")
...
summary_borer %>%
  ...
  labs(x = "Fertilizer Treatment Rate", 
       y = "Percent Incidence Borer") + 
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer Percent Incidence vs Fertilizer Treatment.png")
