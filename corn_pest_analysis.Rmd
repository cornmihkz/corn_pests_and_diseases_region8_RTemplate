...
summary_hopper <-
  hopper_joined_ev %>%
  group_by(Province, Municipality, `Corn Type`, Treatment, `Crop Stage`) %>%
  select(-`Crop Stage`) %>%
...
hopper_joined_ev %>%
  ...
  theme_classic()
ggsave(path = "../pests", filename = "Corn Plant Hopper vs Temperature.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
hopper_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Plant Hopper vs Wind.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
hopper_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Plant Hopper vs Humidity.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
hopper_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Plant Hopper vs Rain.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
ggsave(path = "../pests", filename = "Corn Plant Hopper Percent Incidence vs Corn Type.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_hopper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Corn Plant Hopper Percent Incidence vs Fertilizer Treatment.png", width=plot_width, height=plot_height, dpi=plot_dpi)


# by province
aov_province_hopper <- aov(percent_incidence_hopper ~ Province, data = summary_hopper)
tukeyhsd_province_hopper <- TukeyHSD(aov_province_hopper)
letters_province_hopper <- multcompLetters4(aov_province_hopper, tukeyhsd_province_hopper)
...
summary_hopper_province_bp$province_cld <- 
  as.data.frame.list(letters_province_hopper$Province)$Letters

dunnTest(percent_incidence_hopper ~ Province, data = summary_hopper)

attach(summary_hopper)
province_hopper_df <- as.list.data.frame(dunn.test(percent_incidence_hopper, Province, list = TRUE))
detach(summary_hopper)
...
summary_hopper %>%
  ...
  geom_text(data = summary_hopper_province_bp, aes(label = province_cld,
                y = sd$ymax), vjust = -1, hjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_hopper_province_bp, aes(label = round(w, 2), y = sd$ymax - 5), vjust = -1, hjust = -0.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Earworm",
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../province", filename = "Corn Plant Hopper Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
#  values on boxplots
summary_hopper_corn_stage_bp <- 
  summary_hopper %>% 
  group_by(crop_stage) %>% 
  summarise(w=mean(percent_incidence_hopper), sd = mean_sd(percent_incidence_hopper)) %>% 
  arrange(desc(w))

aov_stage_hopper <- aov(percent_incidence_hopper ~ crop_stage, data = summary_hopper)
tukeyhsd_stage_hopper <- TukeyHSD(aov_stage_hopper)
letters_stage_hopper <- multcompLetters4(aov_stage_hopper, tukeyhsd_stage_hopper)

aov_stage_hopper %>% summary()

summary_hopper_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_hopper$crop_stage)$Letters

dunnTest(percent_incidence_hopper ~ crop_stage, data = summary_hopper)

attach(summary_hopper)
stage_hopper_df <- as.list.data.frame(dunn.test(percent_incidence_hopper, crop_stage, list = TRUE))
detach(summary_hopper)


summary_hopper %>%
  ggplot(aes(crop_stage, percent_incidence_hopper)) + 
  geom_boxplot(aes(fill=crop_stage), show.legend=FALSE) +
  geom_text(data = summary_hopper_corn_stage_bp, aes(label = stage_cld,
                y = sd$ymax ), vjust = -1, hjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_hopper_corn_stage_bp, aes(label = round(w, 2), y = sd$ymax - 5), vjust = -1, hjust = -0.1, alpha = 0.75, color = "darkblue") +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Corn Plant Hopper Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_borer <- aov(percent_incidence_borer ~ Province, data = summary_borer)
tukeyhsd_province_borer <- TukeyHSD(aov_province_borer)
letters_province_borer <- multcompLetters4(aov_province_borer, tukeyhsd_province_borer)
...
summary_borer_province_bp$province_cld <- 
  as.data.frame.list(letters_province_borer$Province)$Letters

dunnTest(percent_incidence_borer ~ Province, data = summary_borer)

attach(summary_borer)
province_borer_df <- as.list.data.frame(dunn.test(percent_incidence_borer, Province, list = TRUE))
detach(summary_borer)
...
summary_borer %>%
  ...
  geom_boxplot(aes(fill=Province), show.legend = FALSE) +
  geom_text(data = summary_borer_province_bp, aes(label = province_cld,
                y = sd$ymax), vjust = -1, hjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_borer_province_bp, aes(label = round(w, 2), y = sd$ymax - 5), vjust = -1, hjust = -0.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Borer",
       title = "Provinces to Borer Incidence") + 
  theme_bw() + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../province", filename = "Corn Borer Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
#  values on boxplots
summary_borer_corn_stage_bp <- 
  summary_borer %>% 
  group_by(crop_stage) %>% 
  summarise(w=mean(percent_incidence_borer), sd = mean_sd(percent_incidence_borer)) %>% 
  arrange(desc(w))

aov_stage_borer <- aov(percent_incidence_borer ~ crop_stage, data = summary_borer)
tukeyhsd_stage_borer <- TukeyHSD(aov_stage_borer)
letters_stage_borer <- multcompLetters4(aov_stage_borer, tukeyhsd_stage_borer)

aov_stage_borer %>% summary()

summary_borer_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_borer$crop_stage)$Letters

dunnTest(percent_incidence_borer ~ crop_stage, data = summary_borer)

attach(summary_borer)
stage_borer_df <- as.list.data.frame(dunn.test(percent_incidence_borer, crop_stage, list = TRUE))
detach(summary_borer)
...
summary_borer %>%
  ...
  geom_boxplot(aes(fill=crop_stage), show.legend=FALSE) +
  geom_text(data = summary_borer_corn_stage_bp, aes(label = stage_cld,
                y = sd$ymax ), vjust = -1, hjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_borer_corn_stage_bp, aes(label = round(w, 2), y = sd$ymax - 5), vjust = -1, hjust = -0.1, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Borer",
       title = "Corn Crop Growth Stages and Borer Incidence") + 
  theme_bw() + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Corn Borer Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
semilooper_joined_ev %>%
  ...
  annotate("label", x = 27, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Semi-looper vs Temperature.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
semilooper_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Semi-looper vs Wind.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
semilooper_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Semi-looper vs Humidity.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
semilooper_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Semi-looper vs Rain.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_semilooper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Semi-looper Percent Incidence vs Corn Type.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_semilooper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Semi-looper Percent Incidence vs Fertilizer Treatment.png", width=plot_width, height=plot_height, dpi=plot_dpi)


# by province
aov_province_semilooper <- aov(percent_incidence_semilooper ~ Province, data = summary_semilooper)
tukeyhsd_province_semilooper <- TukeyHSD(aov_province_semilooper)
letters_province_semilooper <- multcompLetters4(aov_province_semilooper, tukeyhsd_province_semilooper)
...
summary_semilooper_province_bp$province_cld <- 
  as.data.frame.list(letters_province_semilooper$Province)$Letters

dunnTest(percent_incidence_semilooper ~ Province, data = summary_semilooper)

attach(summary_semilooper)
province_semilooper_df <- as.list.data.frame(dunn.test(percent_incidence_semilooper, Province, list = TRUE))
detach(summary_semilooper)
...
summary_semilooper %>%
  ...
  geom_boxplot(aes(fill=Province), show.legend = FALSE) +
  geom_text(data = summary_semilooper_province_bp, aes(label = province_cld,
                y = sd$ymax), vjust = -1, hjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_semilooper_province_bp, aes(label = round(w, 2), y = sd$ymax - 5), vjust = -1, hjust = -0.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Earworm",
       title = "Provinces to Earworm Incidence") + 
  theme_bw() + 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../province", filename = "Semi-looper Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
#  values on boxplots
summary_semilooper_corn_stage_bp <- 
  summary_semilooper %>% 
  group_by(crop_stage) %>% 
  summarise(w=mean(percent_incidence_semilooper), sd = mean_sd(percent_incidence_semilooper)) %>% 
  arrange(desc(w))

aov_stage_semilooper <- aov(percent_incidence_semilooper ~ crop_stage, data = summary_semilooper)
tukeyhsd_stage_semilooper <- TukeyHSD(aov_stage_semilooper)
letters_stage_semilooper <- multcompLetters4(aov_stage_semilooper, tukeyhsd_stage_semilooper)

aov_stage_semilooper %>% summary()

summary_semilooper_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_semilooper$crop_stage)$Letters

dunnTest(percent_incidence_semilooper ~ crop_stage, data = summary_semilooper)

attach(summary_semilooper)
stage_semilooper_df <- as.list.data.frame(dunn.test(percent_incidence_semilooper, crop_stage, list = TRUE))
detach(summary_semilooper)
...
summary_semilooper %>%
  ...
  geom_boxplot(aes(fill=crop_stage), show.legend=FALSE) +
  geom_text(data = summary_semilooper_corn_stage_bp, aes(label = stage_cld,
                y = sd$ymax ), vjust = -1, hjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_semilooper_corn_stage_bp, aes(label = round(w, 2), y = sd$ymax - 5), vjust = -1, hjust = -0.1, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Earworm",
       title = "Corn Crop Growth Stages and Earworm Incidence") + 
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Semi-looper Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
aov_corn_earworm <- aov(percent_incidence_earworm ~ factor_corn, summary_earworm)
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 27, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Earworm vs Temperature.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Earworm vs Wind.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Earworm vs Humidity.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Earworm vs Rain.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_earworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Corn Earworm Percent Incidence vs Corn Type.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_earworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Corn Earworm Percent Incidence vs Fertilizer Treatment.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_earworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Corn Earworm Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_earworm_crop_stage_bp <-
  ...
  select(-c(crop_stage.x, crop_stage.y))
...
summary_earworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Corn Earworm Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_cutworm <- aov(percent_incidence_cutworm ~ Province, data = summary_cutworm)
tukeyhsd_province_cutworm <- TukeyHSD(aov_province_cutworm)
letters_province_cutworm <- multcompLetters4(aov_province_cutworm, tukeyhsd_province_cutworm)
...
summary_cutworm_province_bp$province_cld <- 
  as.data.frame.list(letters_province_cutworm$Province)$Letters

dunnTest(percent_incidence_cutworm ~ Province, data = summary_cutworm)

attach(summary_cutworm)
province_cutworm_df <- as.list.data.frame(dunn.test(percent_incidence_cutworm, Province, list = TRUE))
...
summary_cutworm %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_cutworm_province_bp, aes(label = province_cld,
                y = 45 ), color="red", size = 4) +
  geom_text(data = summary_cutworm_province_bp, aes(label = round(w, 2), y = 50), alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Cutworm",
       title = "Provinces to Cutworm Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Cutworm Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)


# by Crop stage
#  values on boxplots
summary_cutworm_corn_stage_bp <- 
  summary_cutworm %>% 
  group_by(crop_stage) %>% 
  summarise(w=mean(percent_incidence_cutworm), sd = mean_sd(percent_incidence_cutworm)) %>% 
  arrange(desc(w))

aov_stage_cutworm <- aov(percent_incidence_cutworm ~ crop_stage, data = summary_cutworm)
tukeyhsd_stage_cutworm <- TukeyHSD(aov_stage_cutworm)
letters_stage_cutworm <- multcompLetters4(aov_stage_cutworm, tukeyhsd_stage_cutworm)

aov_stage_cutworm %>% summary()

summary_cutworm_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_cutworm$crop_stage)$Letters

dunnTest(percent_incidence_cutworm ~ crop_stage, data = summary_cutworm)

attach(summary_cutworm)
stage_cutworm_df <- as.list.data.frame(dunn.test(percent_incidence_cutworm, crop_stage, list = TRUE))
detach(summary_cutworm)
...
summary_cutworm %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_cutworm_corn_stage_bp, aes(label = stage_cld,
                y = sd$ymax ), vjust = -1, hjust = -1, color="red", size = 4) +
  geom_text(data = summary_cutworm_corn_stage_bp, aes(label = round(w, 2), y = sd$ymax - 5), vjust = -1, hjust = -1, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Cutworm",
       title = "Corn Crop Growth Stages and Cutworm Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Cutworm Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
aov_corn_armyworm <- aov(sum_incidence_armyworm ~ factor_corn, summary_armyworm)
...
# by province
aov_province_armyworm <- aov(percent_incidence_armyworm ~ Province, data = summary_armyworm)
tukeyhsd_province_armyworm <- TukeyHSD(aov_province_armyworm)
letters_province_armyworm <- multcompLetters4(aov_province_armyworm, tukeyhsd_province_armyworm)
...
summary_armyworm_province_bp$province_cld <- 
  as.data.frame.list(letters_province_armyworm$Province)$Letters

dunnTest(percent_incidence_armyworm ~ Province, data = summary_armyworm)

attach(summary_armyworm)
province_armyworm_df <- as.list.data.frame(dunn.test(percent_incidence_armyworm, Province, list = TRUE))
...
summary_armyworm %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_armyworm_province_bp, aes(label = province_cld,
                y = 88), color="red", size = 4) +
  geom_text(data = summary_armyworm_province_bp, aes(label = round(w, 2), y = 81), alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Armyworm",
       title = "Provinces to Armyworm Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Armyworm Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
#  values on boxplots
summary_armyworm_corn_stage_bp <- 
  summary_armyworm %>% 
  group_by(crop_stage) %>% 
  summarise(w=mean(percent_incidence_armyworm), sd = mean_sd(percent_incidence_armyworm)) %>% 
  arrange(desc(w))

aov_stage_armyworm <- aov(percent_incidence_armyworm ~ crop_stage, data = summary_armyworm)
tukeyhsd_stage_armyworm <- TukeyHSD(aov_stage_armyworm)
letters_stage_armyworm <- multcompLetters4(aov_stage_armyworm, tukeyhsd_stage_armyworm)

aov_stage_armyworm %>% summary()

summary_armyworm_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_armyworm$crop_stage)$Letters

dunnTest(percent_incidence_armyworm ~ crop_stage, data = summary_armyworm)

attach(summary_armyworm)
stage_armyworm_df <- as.list.data.frame(dunn.test(percent_incidence_armyworm, crop_stage, list = TRUE))
detach(summary_armyworm)
...
summary_armyworm %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_armyworm_corn_stage_bp, aes(label = stage_cld,
                y = sd$ymax ), vjust = -1, hjust = -1, color="red", size = 4) +
  geom_text(data = summary_armyworm_corn_stage_bp, aes(label = round(w, 2), y = sd$ymax - 5 - 5), vjust = -1, hjust = -1, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Armyworm",
       title = "Corn Crop Growth Stages and Armyworm Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Armyworm Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_aphids <- aov(percent_incidence_aphids ~ Province, data = summary_aphids)
tukeyhsd_province_aphids <- TukeyHSD(aov_province_aphids)
letters_province_aphids <- multcompLetters4(aov_province_aphids, tukeyhsd_province_aphids)
...
summary_aphids_province_bp$province_cld <- 
  as.data.frame.list(letters_province_aphids$Province)$Letters

dunnTest(percent_incidence_aphids ~ Province, data = summary_aphids)

attach(summary_aphids)
province_aphids_df <- as.list.data.frame(dunn.test(percent_incidence_aphids, Province, list = TRUE))
...
summary_aphids %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_aphids_province_bp, aes(label = province_cld,
                y = 60 ), color="red", size = 4) +
  geom_text(data = summary_aphids_province_bp, aes(label = round(w, 2), y = 55), alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Aphids",
       title = "Provinces to Aphids Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Aphids Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
#  values on boxplots
summary_aphids_corn_stage_bp <- 
  summary_aphids %>% 
  group_by(crop_stage) %>% 
  summarise(w=mean(percent_incidence_aphids), sd = mean_sd(percent_incidence_aphids)) %>% 
  arrange(desc(w))

aov_stage_aphids <- aov(percent_incidence_aphids ~ crop_stage, data = summary_aphids)
tukeyhsd_stage_aphids <- TukeyHSD(aov_stage_aphids)
letters_stage_aphids <- multcompLetters4(aov_stage_aphids, tukeyhsd_stage_aphids)

aov_stage_aphids %>% summary()

summary_aphids_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_aphids$crop_stage)$Letters

dunnTest(percent_incidence_aphids ~ crop_stage, data = summary_aphids)

attach(summary_aphids)
stage_aphids_df <- as.list.data.frame(dunn.test(percent_incidence_aphids, crop_stage, list = TRUE))
detach(summary_aphids)
...
summary_aphids %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_aphids_corn_stage_bp, aes(label = stage_cld,
                y = sd$ymax ), vjust = -1, hjust = -1, color="red", size = 4) +
  geom_text(data = summary_aphids_corn_stage_bp, aes(label = round(w, 2), y = sd$ymax - 5), vjust = -1, hjust = -1, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Aphids",
       title = "Corn Crop Growth Stages and Aphids Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Aphids Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
# by province
aov_province_faw <- aov(percent_incidence_faw ~ Province, data = summary_faw)
tukeyhsd_province_faw <- TukeyHSD(aov_province_faw)
letters_province_faw <- multcompLetters4(aov_province_faw, tukeyhsd_province_faw)
...
summary_faw_province_bp$province_cld <- 
  as.data.frame.list(letters_province_faw$Province)$Letters

dunnTest(percent_incidence_faw ~ Province, data = summary_faw)

attach(summary_faw)
province_faw_df <- as.list.data.frame(dunn.test(percent_incidence_faw, Province, list = TRUE))
detach(summary_faw)
...
summary_faw %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_faw_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_faw_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -1, hjust = -1, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence FAW",
       title = "Provinces to FAW Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Corn FAW Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
#  values on boxplots
summary_faw_corn_stage_bp <- 
  summary_faw %>% 
  group_by(crop_stage) %>% 
  summarise(w=mean(percent_incidence_faw), sd = mean_sd(percent_incidence_faw)) %>% 
  arrange(desc(w))

aov_stage_faw <- aov(percent_incidence_faw ~ crop_stage, data = summary_faw)
tukeyhsd_stage_faw <- TukeyHSD(aov_stage_faw)
letters_stage_faw <- multcompLetters4(aov_stage_faw, tukeyhsd_stage_faw)

aov_stage_faw %>% summary()

summary_faw_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_faw$crop_stage)$Letters

dunnTest(percent_incidence_faw ~ crop_stage, data = summary_faw)

attach(summary_faw)
stage_faw_df <- as.list.data.frame(dunn.test(percent_incidence_faw, crop_stage, list = TRUE))
detach(summary_faw)
...
summary_faw %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_faw_corn_stage_bp, aes(label = stage_cld,
                y = sd$ymax ), vjust = -1, hjust = -1, color="red", size = 4) +
  geom_text(data = summary_faw_corn_stage_bp, aes(label = round(w, 2), y = sd$ymax - 5), vjust = -1, hjust = -1, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stage_labels) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence FAW",
       title = "Corn Crop Growth Stages and FAW Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "FAW Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
levenes_pest_values <-
  data.frame(
    Pest = c("Plant Hopper", "Semilooper", "Corn Borer"),
    `Fertilizer F-value` = c(levenes_f_val_fert_hopper, levenes_f_val_fert_semilooper, levenes_f_val_fert_borer),
    `Fertilizer p-value` = c(levenes_p_val_fert_hopper, levenes_p_val_fert_semilooper, levenes_p_val_fert_borer),
    `Corn Type F-value` = c(levenes_f_val_corn_hopper, levenes_f_val_corn_semilooper, levenes_f_val_corn_borer),
    `Corn Type p-value` = c(levenes_p_val_corn_hopper, levenes_p_val_corn_semilooper, levenes_p_val_corn_borer),
    `Province F-value` = c(levenes_f_val_prov_hopper, levenes_f_val_prov_semilooper, levenes_f_val_prov_borer),
    `Province p-value` = c(levenes_p_val_prov_hopper, levenes_p_val_prov_semilooper, levenes_p_val_prov_borer),
    `Corn Stage F-value` = c(levenes_f_val_stage_hopper, levenes_f_val_stage_semilooper, levenes_f_val_stage_borer),
    `Corn Stage p-value` = c(levenes_p_val_stage_hopper, levenes_p_val_stage_semilooper, levenes_p_val_stage_borer)
  )
