...
borer_joined_ev %>%
  ...
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer vs Temperature.png", dpi=plot_dpi)
...
borer_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer vs Wind.png", dpi=plot_dpi)
...
borer_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer vs Humidity.png", dpi=plot_dpi)
...
borer_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Borer vs Rain.png", dpi=plot_dpi)
...
ggsave(path = "../pests", filename = "Corn Borer Percent Incidence vs Corn Type.png", dpi=plot_dpi)
...
summary_borer %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Corn Borer Percent Incidence vs Fertilizer Treatment.png", dpi=plot_dpi)
...
summary_borer %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Corn Borer Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_borer %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Corn Borer Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
semilooper_joined_ev %>%
  ...
  annotate("label", x = 27, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Semi-looper vs Temperature.png", dpi=plot_dpi)
...
semilooper_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Semi-looper vs Wind.png", dpi=plot_dpi)
...
semilooper_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Semi-looper vs Humidity.png", dpi=plot_dpi)
...
semilooper_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Semi-looper vs Rain.png", dpi=plot_dpi)
...
summary_semilooper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Semi-looper Percent Incidence vs Corn Type.png", dpi=plot_dpi)
...
summary_semilooper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Semi-looper Percent Incidence vs Fertilizer Treatment.png", dpi=plot_dpi)
...
summary_semilooper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Semi-looper Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_semilooper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Semi-looper Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 27, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Earworm vs Temperature.png", dpi=plot_dpi)
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Earworm vs Wind.png", dpi=plot_dpi)
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Earworm vs Humidity.png", dpi=plot_dpi)
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Earworm vs Rain.png", dpi=plot_dpi)
...
summary_earworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Corn Earworm Percent Incidence vs Corn Type.png", dpi=plot_dpi)
...
summary_earworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Corn Earworm Percent Incidence vs Fertilizer Treatment.png", dpi=plot_dpi)
...
summary_earworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Corn Earworm Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_earworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Corn Earworm Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
hopper_joined_ev %>%
  ...
  annotate("label", x = 27, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Plant Hopper vs Temperature.png", dpi=plot_dpi)
...
hopper_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Plant Hopper vs Wind.png", dpi=plot_dpi)
...
hopper_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Plant Hopper vs Humidity.png", dpi=plot_dpi)
...
hopper_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Corn Plant Hopper vs Rain.png", dpi=plot_dpi)
...
summary_hopper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Corn Plant Hopper Percent Incidence vs Corn Type.png", dpi=plot_dpi)
...
summary_hopper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Corn Plant Hopper Percent Incidence vs Fertilizer Treatment.png", dpi=plot_dpi)
...
summary_hopper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Corn Plant Hopper Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_hopper %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Corn Plant Hopper Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
cutworm_joined_ev %>%
  ...
  annotate("label", x = 27, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Cutworm vs Temperature.png", dpi=plot_dpi)
...
cutworm_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Cutworm vs Wind.png", dpi=plot_dpi)
...
cutworm_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Cutworm vs Humidity.png", dpi=plot_dpi)
...
cutworm_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Cutworm vs Rain.png", dpi=plot_dpi)
...
summary_cutworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Cutworm Percent Incidence vs Corn Type.png", dpi=plot_dpi)
...
summary_cutworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Cutworm Percent Incidence vs Fertilizer Treatment.png", dpi=plot_dpi)
...
summary_cutworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Cutworm Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_cutworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Cutworm Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_armyworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Armyworm Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_armyworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Armyworm Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_aphids %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "Aphids Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_aphids %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "Aphids Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
...
summary_faw %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "FAW Percent Incidence vs Province.png", dpi=plot_dpi)
...
summary_faw %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), ) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../stage", filename = "FAW Percent Incidence vs Crop Growth Stages.png", dpi=plot_dpi)
