...
stages_description <- c("Emergence", "Single leaf", "Seedling", "Early Whorl", "Mid whorl",
...
# median values on boxplots
summary_borer_province_bp <-
  summary_borer %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_borer), sd = mean_sd(percent_incidence_borer)) %>% 
  arrange(desc(w)) 
...
summary_borer %>%
  ...
  geom_text(data = summary_borer_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Borer",
...
summary_borer %>%
  ...
  geom_text(data = summary_borer_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_borer_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stages_description) +
...
summary_semilooper_province_bp <-
  summary_semilooper %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_semilooper), sd = mean_sd(percent_incidence_semilooper)) %>% 
  arrange(desc(w)) 
...
summary_semilooper %>%
  ...
  geom_text(data = summary_semilooper_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_semilooper_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Semilooper",
       title = "Provinces to Semilooper Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Corn Semilooper Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_semilooper %>%
  ...
  geom_text(data = summary_semilooper_corn_stage_bp, aes(label = stage_cld,
                y = letters_height - 25 ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_semilooper_corn_stage_bp, aes(label = round(w, 2), y = median_height - 25), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stages_description) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Semilooper",
       title = "Corn Crop Growth Stages and Semilooper Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Semilooper Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 28.5, y = 13,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Earworm vs Temperature.png")
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 7, y = 13,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Earworm vs Wind Speed.png")
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 60, y = 13,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Earworm vs Humidity.png")
...
earworm_joined_ev %>%
  ...
  annotate("label", x = 0.5, y = 13,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Earworm vs Rainfall.png")
...
summary_earworm %>%
  ...
  theme_classic()
ggsave(path = "../pests", filename = "Earworm Percent Incidence vs Corn Type.png")
...
summary_earworm %>%
  ...
  theme_classic()
ggsave(path = "../pests", filename = "Earworm Percent Incidence vs Fertilizer Treatment.png")


# by province
aov_province_earworm <- aov(percent_incidence_earworm ~ Province, data = summary_earworm)
tukeyhsd_province_earworm <- TukeyHSD(aov_province_earworm)
letters_province_earworm <- multcompLetters4(aov_province_earworm, tukeyhsd_province_earworm)

# median values on boxplots
summary_earworm_province_bp <-
  summary_earworm %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_earworm), sd = mean_sd(percent_incidence_earworm)) %>% 
  arrange(desc(w)) 

summary_earworm_province_bp$province_cld <- 
  as.data.frame.list(letters_province_earworm$Province)$Letters

dunnTest(percent_incidence_earworm ~ Province, data = summary_earworm)

attach(summary_earworm)
province_earworm_df <- as.list.data.frame(dunn.test(percent_incidence_earworm, Province, list = TRUE))
...
summary_earworm %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_earworm_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_earworm_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Earworm",
...
# by Crop stage
# median values on boxplots
summary_earworm_corn_stage_bp <- 
  summary_earworm %>% 
  group_by(crop_stage) %>% 
  summarise(w=median(percent_incidence_earworm), sd = mean_sd(percent_incidence_earworm)) %>% 
  arrange(desc(w))

aov_stage_earworm <- aov(percent_incidence_earworm ~ crop_stage, data = summary_earworm)
tukeyhsd_stage_earworm <- TukeyHSD(aov_stage_earworm)
letters_stage_earworm <- multcompLetters4(aov_stage_earworm, tukeyhsd_stage_earworm)

aov_stage_earworm %>% summary()

summary_earworm_corn_stage_bp$stage_cld <- 
  as.data.frame.list(letters_stage_earworm$crop_stage)$Letters

dunnTest(percent_incidence_earworm ~ crop_stage, data = summary_earworm)

attach(summary_earworm)
stage_earworm_df <- as.list.data.frame(dunn.test(percent_incidence_earworm, crop_stage, list = TRUE))
detach(summary_earworm)
...
summary_earworm %>%
  ...
  geom_boxplot() +
  geom_text(data = summary_earworm_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_earworm_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stages_description) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Earworm",
       title = "Corn Crop Growth Stages and Earworm Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Earworm Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_hopper_province_bp <-
  summary_hopper %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_hopper), sd = mean_sd(percent_incidence_hopper)) %>% 
  arrange(desc(w)) 
...
summary_hopper %>%
  ...
  geom_text(data = summary_hopper_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_hopper_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Hopper",
       title = "Provinces to Hopper Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Corn Hopper Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_hopper %>%
  ...
  geom_text(data = summary_hopper_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_hopper_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stages_description) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Hopper",
       title = "Corn Crop Growth Stages and Hopper Incidence") + 
  theme_classic()
ggsave(path = "../stage", filename = "Hopper Percent Incidence vs Crop Growth Stages.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_cutworm_province_bp <-
  summary_cutworm %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_cutworm), sd = mean_sd(percent_incidence_cutworm)) %>% 
  arrange(desc(w)) 
...
summary_cutworm %>%
  ...
  geom_text(data = summary_cutworm_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_cutworm_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Cutworm",
       title = "Provinces to Cutworm Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Corn Cutworm Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_cutworm %>%
  ...
  geom_text(data = summary_cutworm_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_cutworm_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stages_description) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Cutworm",
...
summary_armyworm_province_bp <-
  summary_armyworm %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_armyworm), sd = mean_sd(percent_incidence_armyworm)) %>% 
  arrange(desc(w)) 
...
summary_armyworm %>%
  ...
  geom_text(data = summary_armyworm_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_armyworm_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Armyworm",
       title = "Provinces to Armyworm Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Corn Armyworm Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_armyworm %>%
  ...
  geom_text(data = summary_armyworm_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_armyworm_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stages_description) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Armyworm",
...
summary_aphids_province_bp <-
  summary_aphids %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_aphids), sd = mean_sd(percent_incidence_aphids)) %>% 
  arrange(desc(w)) 
...
summary_aphids %>%
  ...
  geom_text(data = summary_aphids_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_aphids_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence Aphids",
       title = "Provinces to Aphids Incidence") + 
  theme_classic()
ggsave(path = "../province", filename = "Corn Aphids Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_aphids %>%
  ...
  geom_text(data = summary_aphids_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_aphids_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stages_description) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence Aphids",
...
summary_faw_province_bp <-
  summary_faw %>% 
  group_by(Province) %>% 
  summarise(w=median(percent_incidence_faw), sd = mean_sd(percent_incidence_faw)) %>% 
  arrange(desc(w)) 
...
summary_faw %>%
  ...
  geom_text(data = summary_faw_province_bp, aes(label = province_cld,
                y = w + sd$ymax - 1 ), vjust = -0.5, color="red", size = 4) +
  geom_text(data = summary_faw_province_bp, aes(label = round(w, 2), y = sd$ymax), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  labs(x = "Provinces", 
       y = "Percent Incidence FAW",
...
summary_faw %>%
  ...
  geom_text(data = summary_faw_corn_stage_bp, aes(label = stage_cld,
                y = letters_height ), vjust = -3, color="red", size = 4) +
  geom_text(data = summary_faw_corn_stage_bp, aes(label = round(w, 2), y = median_height), vjust = -5.5, alpha = 0.75, color = "darkblue") +
  scale_x_discrete(limits = crop_growth_stages, labels=stages_description) +
  labs(x = "Corn Growth Stages", 
       y = "Percent Incidence FAW",
...
kruskal_stage_faw   <- kruskal.test(percent_incidence_faw ~ `Crop Stage`, summary_faw)
