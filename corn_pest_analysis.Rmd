...
summary_armyworm %>%
  ...
  geom_text(data = summary_armyworm_fert_bp, aes(label = round(w, 2), y = sd$y), vjust = -2, hjust = -1, alpha = 0.75, color = "darkblue") +
  labs(x = "Fertilizer Treatment Rate", 
       y = "Percent Incidence Armyworm",
       title = "Effect of Fertilizer Treatment Rate on Armyworm Incidence") + 
  theme_classic()
ggsave(path = "../pests_fertilizer_rate", filename = "Armyworm Percent Incidence vs Fertilizer Treatment.png")
