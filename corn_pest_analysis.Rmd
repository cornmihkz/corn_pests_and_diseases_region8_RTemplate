...
cutworm_joined_ev %>%
  ...
  annotate("label", x = 27, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Cutworm vs Temperature.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
cutworm_joined_ev %>%
  ...
  annotate("label", x = 7, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Cutworm vs Wind.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
cutworm_joined_ev %>%
  ...
  annotate("label", x = 60, y = 8,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Cutworm vs Humidity.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
cutworm_joined_ev %>%
  ...
  annotate("label", x = 0.4, y = 10,  
           ...
           parse = TRUE, color = "red", size = 5) +
  theme_classic()
ggsave(path = "../pests", filename = "Cutworm vs Rain.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_cutworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Cutworm Percent Incidence vs Corn Type.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
summary_cutworm %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1")
ggsave(path = "../pests", filename = "Cutworm Percent Incidence vs Fertilizer Treatment.png", width=plot_width, height=plot_height, dpi=plot_dpi)
...
aov_crop_stage <- aov(percent_incidence_faw ~ crop_stage, summary_faw)
...
tukey_stage_faw <- TukeyHSD(aov_crop_stage)
...
summary_faw %>%
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_brewer(palette = "Pastel1") 
ggsave(path = "../province", filename = "FAW Percent Incidence vs Province.png", width=plot_width, height=plot_height, dpi=plot_dpi)



# by Crop stage
# anova by corn stage
tukey_crop_stage_faw_letters <- multcompLetters4(aov_crop_stage, tukey_stage_faw)
...
levenes_pest_values <-
  data.frame(
    Pest = c("Plant Hopper", "Semilooper", "Corn Borer","FAW", "Aphids", "Earworm", "Armyworm", "Cutworm"),
