...
# Pinabacdao, Samar Weather Online
driver = webdriver.Chrome()

driver.get('https://www.worldweatheronline.com/pinabacdao-weather-history/samar/ph.aspx')

driver.find_element(By.XPATH, '//*[@id="aspnetForm"]/section[1]/div/div/div/div[1]/div/div/a[4]').click()

with open('Pinabacdao Weather.csv', 'w') as f:
	writer = csv.writer(f)
	...
	for date in range(len(all_date_values)):
		...
		writer.writerow([new_date_value, 'Pinabacdao', day_temperature, day_rainfall, day_windspeed, day_humidity])
