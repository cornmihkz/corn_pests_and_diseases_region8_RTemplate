...
# Tomas Oppus, Southern Leyte Weather Online
driver = webdriver.Chrome()

driver.get('https://www.worldweatheronline.com/tomas-oppus-weather-history/southern-leyte/ph.aspx')


with open('Tomas Oppus Weather.csv', 'w') as f:
	writer = csv.writer(f)
	...
	for date in range(len(all_date_values)):
		...
		day_humidity  	 = driver.find_element(By.XPATH, "//*[@id='aspnetForm']/section[2]/div/div/div[1]/div[4]/div[1]/div/div[3]/table/tbody/tr[5]/td[6]").text.rstrip("%")
		...
		day_windspeed    = driver.find_element(By.XPATH, "//*[@id='aspnetForm']/section[2]/div/div/div[1]/div[4]/div[1]/div/div[3]/table/tbody/tr[5]/td[8]/div[2]").text.rstrip(" km/h")

		writer.writerow([new_date_value, 'Tomas Oppus', day_temperature, day_rainfall, day_windspeed, day_humidity])
