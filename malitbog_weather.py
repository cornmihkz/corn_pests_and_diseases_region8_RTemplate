...
# Malitbog, Southern Leyte Weather Online
...
with open('Malitbog Weather.csv', 'w') as f:
	writer = csv.writer(f)
	...
	for date in range(len(all_date_values)):
		...
		writer.writerow([new_date_value, 'Malitbog', day_temperature, day_rainfall, day_windspeed, day_humidity])
